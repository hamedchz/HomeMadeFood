    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                <li @class([
                    'menu-item ',
                    'menu-item-active' => in_array('dashboard', $scope),
                ]) aria-haspopup="true">
                ...
                <li class="menu-section">
                    <h4 class="menu-text">{{ trans('Roles & Users') }}</h4>
                ...
                <li @class([
                    ...
                    'menu-item-open' => in_array('roles', $scope),
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('role-list', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.role.list', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('All Roles') }}</span>
                                </a>
                            </li>
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('role-create', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.role.create', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('New Role') }}</span>
                                </a>
                ...
                <li @class([
                    'menu-item menu-item-submenu',
                    'menu-item-open' => in_array('admins', $scope),
                ]) aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                        ...
                        <span class="menu-text">{{ trans('Admins') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('admins-list', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.admins.list', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('All Admins') }}</span>
                                </a>
                            </li>
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('admins-create', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.admins.create', app()->getLocale()) }}"
                                    ...
                                    <span class="menu-text">{{ trans('New Admin') }}</span>
                                </a>
                ...
                <li @class([
                    'menu-item menu-item-submenu',
                    'menu-item-open' => in_array('users', $scope),
                ]) aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-list', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.all', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('All Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-primary">{{ $allUsers }}</span>
                                    </span>
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-approved', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.approved', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Approved Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-success">{{ $approvedUsers }}</span>
                                    </span>
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-inprogress', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.in-progress', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('InProgress Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-warning">{{ $inProgressUsers }}</span>
                                    </span>
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-pending', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.pending', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Pending Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-info">{{ $pendingUsers }}</span>
                                    </span>
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-rejected', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.rejected', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Rejected Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-danger">{{ $rejectedUsers }}</span>
                                    </span>
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('users-suspended', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.users.suspended', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Suspended Users') }}</span>
                                    <span class="menu-label">
                                        <span class="label label-rounded label-secondary">{{ $suspendedUsers }}</span>
                                    </span>
                ...
                <li class="menu-section">
                    <h4 class="menu-text">{{ trans('Packages') }}</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li @class([
                    'menu-item menu-item-submenu',
                    'menu-item-open' => in_array('packages', $scope),
                ]) aria-haspopup="true" data-menu-toggle="hover">
                    <a href="javascript:;" class="menu-link menu-toggle">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-4-blocks.svg-->
                        ...
                        <span class="menu-text">{{ trans('Packages') }}</span>
                        <i class="menu-arrow"></i>
                    </a>
                    ...
                    <div class="menu-submenu">
                        ...
                        <ul class="menu-subnav">
                            ...
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' => in_array('package-list', $scope),
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.package.list', app()->getLocale()) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('All Packages') }}</span>
                                </a>
                            </li>
                            <li @class([
                                'menu-item menu-item-submenu',
                                'menu-item-active' =>
                                    in_array('package-create', $scope) &&
                                    request()->has('type') &&
                                    request()->type == \App\Enums\Casts\PackageType::Advisor->value,
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.package.create', [app()->getLocale(), 'type' => \App\Enums\Casts\PackageType::Advisor->value]) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Advisor New Package') }}</span>
                                </a>
                            ...
                            <li @class([
                                ...
                                'menu-item-active' =>
                                    in_array('package-create', $scope) &&
                                    request()->has('type') &&
                                    request()->type == \App\Enums\Casts\PackageType::Business->value,
                            ]) aria-haspopup="true" data-menu-toggle="hover">
                                <a href="{{ route('admin.package.create', [app()->getLocale(), 'type' => \App\Enums\Casts\PackageType::Business->value]) }}"
                                    class="menu-link menu-toggle">
                                    <i class="menu-bullet menu-bullet-line">
                                        <span></span>
                                    </i>
                                    <span class="menu-text">{{ trans('Business New Package') }}</span>
                                </a>
                ...
                <li class="menu-section">
                    <h4 class="menu-text">{{ trans('Orders') }}</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li @class([
                    'menu-item ',
                    'menu-item-active' => in_array('orders', $scope),
                ]) aria-haspopup="true">
                    <a href="{{ route('admin.order.list', app()->getLocale()) }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                ...
                                <defs></defs>
                                <g id="Stockholm-icons-/-Shopping-/-Cart1" stroke="none" stroke-width="1"
                        ...
                        <span class="menu-text">{{ trans('All Orders') }}</span>
                    </a>
                </li>
                ...
                <li class="menu-section">
                    <h4 class="menu-text">{{ Str::upper(trans('Finance')) }}</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                <li @class([
                    'menu-item ',
                    'menu-item-active' => in_array('withdrawals', $scope),
                ]) aria-haspopup="true">
                    <a href="{{ route('admin.finance.withdrawals-requests.list', app()->getLocale()) }}"
                        class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                ...
                                <defs></defs>
                                <g id="Stockholm-icons-/-Shopping-/-ATM" stroke="none" stroke-width="1"
                                    fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                    <rect id="Rectangle-2" fill="#000000" opacity="0.3" x="2" y="4" width="20"
                                        height="5" rx="1"></rect>
                                    <path
                        ...
                        <span class="menu-text">{{ trans('Withdrawal Requests') }}</span>
                    </a>
                </li>
                <li @class([
                    'menu-item ',
                    'menu-item-active' => in_array('invoices', $scope),
                ]) aria-haspopup="true">
                    <a href="{{ route('admin.finance.invoices.list', app()->getLocale()) }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <desc>Created with Sketch.</desc>
                                <defs></defs>
                                <g id="Stockholm-icons-/-Shopping-/-Ticket" stroke="none" stroke-width="1"
                                    fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                    <path
                        ...
                        <span class="menu-text">{{ trans('Invoices') }}</span>
                    </a>
                </li>
                <li @class([
                    'menu-item ',
                    'menu-item-active' => in_array('transaction', $scope),
                ]) aria-haspopup="true">
                    <a href="{{ route('admin.finance.transactions.list', app()->getLocale()) }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg width="24px" height="24px" viewBox="0 0 24 24" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                ...
                                <defs></defs>
                                <g id="Stockholm-icons-/-Shopping-/-Credit-card" stroke="none" stroke-width="1"
                                    fill="none" fill-rule="evenodd">
                                    <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                                    <rect id="Combined-Shape" fill="#000000" opacity="0.3" x="2" y="5"
                                        width="20" height="14" rx="2"></rect>
                                    <rect id="Rectangle-59" fill="#000000" x="2" y="8" width="20"
                                        height="3"></rect>
                                    <rect id="Rectangle-59-Copy" fill="#000000" opacity="0.3" x="16" y="14"
